...
public class LoginFragment extends Fragment {
    ...
    public void onButtonPressed() {
        if (mListener != null) {
            ...
            //textView received param 2 of cadastroFragment
            textView.setText(getmParam2());

            //Get value the field and attr to param1 and store and send to CadastroFragment
            setmParam1(editText.getText().toString());
        }
    }
